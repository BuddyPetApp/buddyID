...
const LOGOMARK_XML = `<svg viewBox="0 0 22.0845 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M11.0402 10.3405C10.1722 9.78519 9.35236 9.12219 8.61019 8.4002C7.57911 7.39715 6.73496 6.31472 6.15451 5.32417C5.55739 4.30516 5.29976 3.48657 5.29976 2.98937C5.29976 2.16586 5.80825 1.45381 6.88317 0.898086C7.96434 0.339156 9.47381 0.032608 11.0402 0.032608C12.6065 0.032608 14.116 0.339156 15.1971 0.898086C16.2721 1.45381 16.7805 2.16586 16.7805 2.98937C16.7805 3.48657 16.5229 4.30516 15.9258 5.32417C15.3454 6.31472 14.5012 7.39715 13.4701 8.4002C12.7279 9.12219 11.9081 9.78519 11.0402 10.3405Z" FILL_ATTR/>
</svg>`;

const logoAccent = require('../../assets/buddy-logo-accent.svg');
const logoWhite = require('../../assets/buddy-logo-white.png');

const sizes = {
  sm: { logoW: 90, logoH: 22 },
  md: { logoW: 120, logoH: 30 },
  lg: { logoW: 160, logoH: 40 },
} as const;
